#include<iostream> // given a number and an array return a an consisting 
//of values of given array that contains the elements with sum uqual to given number
...
int cansum(int num,int *a,int *ma,int size){
    ...
    if (num==0){
        return 1;
        // return an array with value num
    }
    else if (num<0){
        return 0;
    }
